...
function Play:update(dt)
  ...
  if col1 == true then
    if love.timer.getTime() - time2 > workrate then
  ...
  if col2 == true then
    if love.timer.getTime() - time3 > workrate then
      if eggsdone > 0 then
        eggsdone = eggsdone - 1
  ...
  if col3 == true then
    money = money + eggscookedheld
    eggscookedheld = 0
  end

  if col4 == true then
    -- make gamestate for upgrades
  end
...
function Play:draw()
  ...
  love.graphics.print("STAMINA: "..stamina,0, 140)
  love.graphics.print("MONEY: "..money,0,160)
  love.graphics.print("RAW EGGS: "..eggsheld,0, 100)
  love.graphics.print("COOKED EGGS: "..eggscookedheld,0, 120)
  love.graphics.draw(eggman,px,py)
